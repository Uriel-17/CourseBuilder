...
/**Manipulation Procedures*/
    ...
    public void remove(T t) {
        ...
        if(Table.get(index).isEmpty()) {
            ...
            System.out.println(t instanceof Classes);
            return;
...
/**Additional Methods*/
    ...
    /**
     * Prints out all of the data inside of the HashTable
     */
    public void print4Project() {
        ...
        for(int i = 0; i < Table.size(); i++) {
            ...
            if(Table.get(i).isEmpty()) {
                ...
                while(!Table.get(i).offEnd()) {
                    ...
                    System.out.println(Table.get(i).getIterator() + "\n");
    ...
    /**
     * Prints the object that was passed in by searching through
     * the hashTable
     * @param t the object that is inside of the hashtable
     */
    public void printSpecificObject(T t) {

        int index = hash(t);

        if(Table.get(index).linearSearch(t) != -1) {

            System.out.println(Table.get(index).getIterator() + "\n");

        } else {

            System.out.println("I was unable to find it");
